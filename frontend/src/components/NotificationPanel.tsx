...
function ProviderIcon({ providerId }: { providerId: string }): React.ReactElement {
  switch (providerId) {
    ...
    case 'social':
      return (
        <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true" style={{ flexShrink: 0, color: 'var(--text-secondary)' }}>
...
const EVENT_TYPES: { id: string; label: string }[] = [
  ...
  { id: 'social.post.created', label: 'New Post' },
  { id: 'social.new_follower', label: 'New Follower' },
];
