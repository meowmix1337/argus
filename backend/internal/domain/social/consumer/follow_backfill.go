...
func (c *FollowBackfillConsumer) Topic() string { return publisher.TopicUserFollowed }
...
func (c *FollowBackfillConsumer) process(payload publisher.UserFollowedPayload) error {
