...
func (c *FollowerNotificationConsumer) Topic() string { return publisher.TopicPostCreated }
...
func (c *FollowerNotificationConsumer) process(payload publisher.PostCreatedPayload) error {
